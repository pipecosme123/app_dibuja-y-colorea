      ...
      <ThemeProvider theme={theme}>
         <BrowserRouter>
            <Routes>
               ...
               <Route exact path={RoutersLinks.View_Odontologos} element={<ViewDrawings tipo={'odontologos'} titulo={'Odontólogos y Pacientes'} />} />
               <Route exact path={RoutersLinks.View_Colaboradores} element={<ViewDrawings tipo={'empleados'} titulo={'Colaboradores de Colgate'} />} />
